<?php namespace App\Http\Controllers;
	...
	class AdminSiswasController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Kelamin","name"=>"kelamin","width"=>"100"];
			$this->col[] = ["label"=>"Alamat","name"=>"alamat","width"=>"100"];
			$this->col[] = ["label"=>"Skor","name"=>"skor","width"=>"100"];
			...
			//$this->form[] = ["label"=>"Kelamin","name"=>"kelamin","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
